...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "XTREME~XMD~K4pSASQZ#PT5W2g98e24SNPsr7GTL8q0qWThQfIwNMnh6uKUj24g",
// add your Session Id 
...
STICKER_NAME: process.env.STICKER_NAME || "༄☥ᐯ丨匚Ҝㄚ ㄒ乇匚卄(😎)☘️᪳࿐",
...
OWNER_NAME: process.env.OWNER_NAME || "ᐯ丨匚Ҝㄚ ㄒ乇匚卄(😎)",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/e6orj5.jpg",
// add img for alive msg
ALIVE_MSG: process.env.ALIVE_MSG || "dm me later",
// add alive msg here 
